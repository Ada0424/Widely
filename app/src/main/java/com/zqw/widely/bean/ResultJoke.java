...
public class ResultJoke implements Parcelable {
    ...
    public static class ResultBean implements Parcelable {
        ...
        protected ResultBean(Parcel in) {
            ...
            in.readList(this.data, Joke.class.getClassLoader());
        }
    ...
    protected ResultJoke(Parcel in) {
        this.error_code = in.readInt();
        this.reason = in.readString();
        this.result = in.readParcelable(ResultBean.class.getClassLoader());
    }

    public static final Parcelable.Creator<ResultJoke> CREATOR = new Parcelable.Creator<ResultJoke>() {
        @Override
        public ResultJoke createFromParcel(Parcel source) {
            return new ResultJoke(source);
        }

        @Override
        public ResultJoke[] newArray(int size) {
            return new ResultJoke[size];
        }
    };
}